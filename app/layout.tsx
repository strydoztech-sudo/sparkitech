...
export const metadata: Metadata = {
  title: 'Spark Info Tech Solutions | CCTV & IT Services Poonamallee',
  ...
  keywords: 'CCTV installation Poonamallee, security camera Tamil Nadu, web development, billing software, intercom, security gate, Spark Info Tech',
  openGraph: {
    title: 'Spark Info Tech Solutions',
    description: 'CCTV & IT Solutions - Poonamallee, Tamil Nadu',
